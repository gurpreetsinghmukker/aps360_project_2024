...
from models import *
from mtg_contrastive_stripped import MTGContrastiveDataset, worker_init_fn , AudioProcessor, AudioProcessor2, ImprovedAudioProcessor
...
if __name__ == '__main__':
    ...
    audio_loader = ImprovedAudioProcessor(references_sample_rate)
    
    mtg_train_dataset = MTGContrastiveDataset(audio_loader, mtg_path ,  references_sample_rate, mask_prob=0.8, samples_per_file=15, folder_whitelist=train_folders, concurrent_files=batch_size)
    mtg_val_dataset = MTGContrastiveDataset(audio_loader, mtg_path,  references_sample_rate, mask_prob=0.8, samples_per_file=15, folder_whitelist=val_folders, max_files=2*batch_size, concurrent_files=batch_size)
